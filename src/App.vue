                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h6 class="card-subtitle mb-2 text-muted" v-else>Insira os participantes no passo anterior
                            </h6>
                        </div>
                    </div>
                    ...
                    <div class="card mt-3">
                        <div class="card-body">
                            ...
                            <button type="button" class="btn w-100 btn-success" @click="processar()">Processar e
                                enviar</button>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        enviarApi() {
            ...
            if (!this.textoToken) {
                alert("TOKEN DA API NÃO ENVIADO")
                return;
            }
            ...
            this.jsonEnvio.forEach(item => {
                post({
                    ...
                    headers: {
                        'auth-key': this.textoToken
                    },
                    body: {
                        sender: '5515998027734',
                        receivers: item.numero,
